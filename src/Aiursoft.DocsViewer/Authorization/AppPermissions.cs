namespace Aiursoft.DocsViewer.Authorization;
...
public class AppPermissions
{
    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanReadComments,
                localizer["Read Comments"],
                localizer["Allows viewing the site-wide comment management center."]),
            new(AppPermissionNames.CanModerateComments,
                localizer["Moderate Comments"],
                localizer["Allows approving, rejecting, and replying to comments."]),
            new(AppPermissionNames.CanDeleteComments,
                localizer["Delete Comments"],
                localizer["Allows permanently deleting comments and their replies."]),
